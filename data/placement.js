(function () {
  ...
  const placements = {
    ...
    chris: ['Child generation of Buzz and June', 'Chris is shown in the Vigneau child generation, with Keri nested as spouse and Amanda/Anna below as user-confirmed children.', 'Annette’s dashed card under Chris is a candidate hypothesis only, not confirmed parentage.'],
    ...
    nina: ['Child generation of Buzz and June', 'The verified Vigneau/Affholter family structure identifies Nina as their child; user-supplied notes give birth year 1958.', 'Her 1981 marriage to Merle Sievert is a timeline fact, not the basis for her child placement and not an exclusion from a 1979 birth.'],
    andrews: ['Child generation below Nina', 'User confirmation identifies Andrew Sievert as a child of Nina Vigneau.', 'This supports Andrew’s placement below Nina; it does not attach Briget or resolve unrelated Sievert leads.'],
    matts: ['Child generation below Nina', 'User confirmation identifies Matt Sievert as a child of Nina Vigneau.', 'This supports Matt’s placement below Nina; it does not attach Briget or resolve unrelated Sievert leads.'],
    adams: ['Child generation below Nina', 'User confirmation identifies Adam Sievert as a child of Nina Vigneau.', 'This supports Adam’s placement below Nina; it does not attach Briget or resolve unrelated Sievert leads.'],
    ...
    janet: ['Edward/Theresa child generation', 'Janet is shown in Edward and Theresa’s child generation and remains the leading Lauer-side historical candidate.', 'Annette’s dashed card under Janet is a candidate hypothesis only, not confirmed parentage.'],
    cindy: ['Edward/Theresa child generation', 'Edward H. Lauer’s 1997 obituary identifies Cynthia “Cindy” Lauer Van Berlo as one of Edward and Theresa’s children; Martin/Martie Van Berlo is nested on Cindy’s card as her married-in spouse.', 'Her June 1979 marriage supports timeline research but does not establish parentage of Annette.'],
    ...
    catherine: ['Edward/Theresa child generation', 'Edward H. Lauer’s 1997 obituary identifies Catherine Lauer as one of Edward and Theresa’s children and says she predeceased Edward.', 'No descendant claims are drawn from this obituary entry.'],
    james: ['Edward/Theresa child generation', 'Edward H. Lauer’s 1997 obituary identifies James Lauer as one of Edward and Theresa’s children.', 'No spouse or descendant claims are drawn from this obituary entry.'],
    lawrence: ['Edward/Theresa child generation', 'Edward H. Lauer’s 1997 obituary identifies Lawrence Lauer as one of Edward and Theresa’s children.', 'No spouse or descendant claims are drawn from this obituary entry.'],
    timothy_lauer: ['Edward/Theresa child generation', 'Edward H. Lauer’s 1997 obituary identifies Timothy Lauer as one of Edward and Theresa’s children.', 'No spouse or descendant claims are drawn from this obituary entry.'],
    ...
    donald: ['Donald / Velda branch', 'Verified family reconstruction identifies Donald and Velda as a couple in the broader Lauer tree.', 'The confirmed Lori-to-Richard/Betty line keeps this branch from being Annette’s leading Lauer parent path.'],
    velda: ['Donald / Velda branch', 'Verified family reconstruction identifies Velda and Donald as a couple.', 'The confirmed Lori-to-Richard/Betty line keeps this branch from being Annette’s leading Lauer parent path.'],
    ...
    wife: ['Candidate hypothesis display', 'Annette was born March 9, 1979; likely conception is June 1978.', 'Shown under Chris and Janet only as the strongest current candidate-pair hypothesis, not confirmed parentage.']
  };
